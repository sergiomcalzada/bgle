...
{
    public class EntityDoesNotExistValidator<TEntity> : BaseEntityValidator<TEntity> where TEntity : class, IEntity
    {
    ...
    public class EntityDoesNotExistValidator<TEntity, TEntityType> : EntityDoesNotExistValidator<TEntity> where TEntity : class, IEntity<TEntityType>
    {
